<div id="dlgsubActivity" class="easyui-dialog" closed="true" style="width:500px; padding:5px; height: auto;" buttons="#subActivitybutton" modal="true" >
    ...
    <div class='form-group' style='' >
        <label>Database Entity</label>
        <select name='entityId' id='entityId' class="easyui-combobox form-control" style="height:30px; width:100%;" data-options="url:'../entitys/viewcombobox',valueField:'tableName',textField:'tableName',panelWidth:'450',panelHeight:'auto',onSelect:function(value){ $('#link').val('../'+value.tableName+'s/view')}"></select>
    </div>
    <div class='form-group form-float' >
