...
<footer id="footer" class="section section-grey">
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
		            ...
		            <img src="../../public/img/logo2.png" alt="">
						...
						<p>Reality house is a architectural community colob to allow.....</p>
				...
				<div class="col-md-3 col-sm-6 col-xs-6">
					<div class="footer">
						<h3 class="footer-header">Go to</h3>
						<ul class="list-links">
							<li><a href="#">New</a></li>
							<li><a href="#">Tending</a></li>
							<li><a href="#">Client Build</a></li>
    ...
    <script  src="../../public/plugins/scripts/jquery/jquery.easyui.min.js"></script>
